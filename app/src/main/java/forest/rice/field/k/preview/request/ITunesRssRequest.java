...
public class ITunesRssRequest extends AbstractRequest {
    ...
    private String endpoint = "https://itunes.apple.com/%s/rss/topsongs/limit=100/json";

    @Override
    public String getJson() throws IOException {

        URL url = new URL(String.format(endpoint, getCountry()));
    ...
    private String getCountry() {
        return Country.selectedCountryCode;
    }
